    ...
    for i in range(1, len(relative_coords)):
        ...
        #     )
            ...
            if vehicle_node in lane_position_indicator["front"] or (
                vehicle_node == lane_position_indicator["current"][0]
                and relative_coords[i].x > 0
                and abs(relative_coords[i].y) < 0.5
            ):
...
def get_around_vehicle(nearest_vehicles, has_traffic_light=False):
    ...
    for key, vehicles in nearest_vehicles.items():
        ...
        if key == "front":
            if vehicle[-1] == "node":
                user_message += f"The vehicle {vehicle[0]} is driving in directly front of you. The distance is {vehicle[1]:.2f}m. Velocity is {vehicle[2]:.2f}m/s. Heading is {vehicle[3]:.2f}pi."
            else:
                user_message += f"The vehicle {vehicle[0]} is driving in directly front of you, in the same lane. The distance is {vehicle[1]:.2f}. Velocity is {vehicle[2]:.2f}m/s. Heading is {vehicle[3]:.2f}pi."
            ...
            if vehicle[-1] == "node":
                user_message += f"The vehicle {vehicle[0]} is driving in {key} of you. The distance is {vehicle[1]:.2f}m. Velocity is {vehicle[2]:.2f}m/s. Heading is {vehicle[3]:.2f}pi."
            else:
                user_message += f"The vehicle {vehicle[0]} is driving in {key} of you, in the left adjacent lane. The distance is {vehicle[1]:.2f}m. Velocity is {vehicle[2]:.2f}m/s. Heading is {vehicle[3]:.2f}pi."
            if vehicle[2] == 0 and has_traffic_light:
                user_message += "He is waiting for the red light."
            elif vehicle[2] < 2 and has_traffic_light:
                user_message += "He is was just waiting for the red light."
            ...
            if vehicle[-1] == "node":
                ...
                user_message += f"The vehicle {vehicle[0]} is driving in {key} of you, in the right adjacent lane. The distance is {vehicle[1]:.2f}m. Velocity is {vehicle[2]:.2f}m/s. Heading is {vehicle[3]:.2f}pi."
            if vehicle[2] == 0 and has_traffic_light:
                user_message += "He is waiting for the red light."
            elif vehicle[2] < 2 and has_traffic_light:
                user_message += "He is was just waiting for the red light."
