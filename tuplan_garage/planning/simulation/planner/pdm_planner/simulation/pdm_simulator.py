...
class PDMSimulator:
    ...
    def simulate_proposals(
        ...
        # t=self._proposal_sampling.num_poses
        # for i in range(len(states)):
        #     states[i][t]=(states[i][t]+states[i][t+1])/2
            # for j in range(0, self._proposal_sampling.num_poses + 1):
            #     states[i][j] = state_copy[i][math.floor(j * 1.2)]
